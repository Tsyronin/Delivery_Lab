...
namespace DeliveryLab.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var labContext = _context.Orders.Include(o => o.Customer).Include(o => o.Delivery).Include(o => o.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,CustomerId,DeliveryId,Time")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
